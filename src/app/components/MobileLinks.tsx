...
//     )
// }
export default function MobileLinks({ isVisible = false }) {
    ...
    return (
        <div className="md:hidden" id="mobile-menu" style={{ maxHeight: `${height}`, transition: 'max-height 0.5s ease', overflow: 'hidden' }}>
